...
<?= $form->field($innUserRegister, 'username', ['options' => ['class' => 'form-group col-12 col-md-4']])->textInput([
    'hidden' => true,
    'value' => $inn->getPhoneFromSession()
])->label(false) ?>

<?= $form->field($innUserRegister, 'inn', ['options' => ['class' => 'form-group col-12 col-md-4']])->textInput([
    'hidden' => true,
    'value' => $inn->getInn()
])->label(false) ?>
...
<?php if (Yii::$app->session->get('smsInnSended')): ?>
    <div class="pl-3">
        ...
        <p class="text-black"><?= t('Your INN:') ?><span class="text-info"> <?= $innUserRegister->inn ?></span></p>
...
<?php if (Yii::$app->session->get('smsInnSended') && !Yii::$app->session->get('tempUserInnVerified')): ?>
    <div class="form-row">
        <?= $form->field($innUserRegister, 'code', ['options' => ['class' => 'form-group col-12 col-md-4']])->textInput([
            'class' => 'form-control',
...
<?php if (Yii::$app->session->get('tempUserInnVerified')): ?>
    <div class="form-row">
        <?= $form->field($innUserRegister, 'email', [
            'options' => [
        ...
        <?= $form->field($innUserRegister, 'password', ['options' => ['class' => 'form-group col-12 col-md-4 show-password']])->passwordInput([
    ...
    <div class="form-row ">
        ...
        <?= $form->field($innUserRegister, 'password_repeat', ['options' => ['class' => 'form-group col-12 col-md-4']])->passwordInput([
            'class' => 'form-control',
            'required' => 'required',
