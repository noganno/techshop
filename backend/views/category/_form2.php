            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <?php if ($node->lvl == 1): ?>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <img class="thumbnail" id="preview_image"  width="200px"
                                     src="<?= $node->menu_image ?>">
                            </div>
                            <div class="col-sm-8">
                                <?= $form->field($node, 'menu_image')->widget(InputFile::className(), [
                                    'language' => 'ru',
                                ...
                                ])->label(t('Image for menu')); ?>
                            </div>
                        </div>
                    <?php endif ?>
            <div class="row">
                <div class="col-sm-4">
                            <img class="thumbnail" id="preview_image" width="200px" src="<?= $node->image ?>" >
                </div>
                <div class="col-sm-8">
                ...
                <div class="col-sm-12">
                    <?= $nameField ?>
                    <?= $form->field($node, 'name_uz')->textInput($inputOpts) ?>
                    <?= $form->field($node, 'name_kr')->textInput($inputOpts) ?>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <?php if ($node->lvl == 2): ?>
                                <?= $form->field($node, 'position')->dropDownList([
                                    '0' => t('Below'),
                                    '1' => t('New column'),
                                ]); ?>
                            <?php endif ?>
                    ...
                    <div class="row">
                        <?= $form->field($node, 'meta_title_ru')->textInput() ?>
                        <?= $form->field($node, 'meta_title_kr')->textInput() ?>
                        <?= $form->field($node, 'meta_title_uz')->textInput() ?>
                        <?= $form->field($node, 'meta_description_ru')->textArea(['rows' => 2]) ?>
                        <?= $form->field($node, 'meta_description_kr')->textArea(['rows' => 2]) ?>
                        <?= $form->field($node, 'meta_description_uz')->textArea(['rows' => 2]) ?>
                        <?= $form->field($node, 'meta_keywords_ru')->textInput() ?>
                        <?= $form->field($node, 'meta_keywords_kr')->textInput() ?>
                        <?= $form->field($node, 'meta_keywords_uz')->textInput() ?>
                    </div>
                </div>
            </div>
        <?php else : ?>
