...
class News extends \soft\db\SActiveRecord
{
    ...
    {
        return [
            [['created_at', 'updated_at', 'status', 'user_id', 'view', 'like', 'published_at'], 'integer'],
            [['slug'], 'string', 'max' => 255],
    ...
    {
        $query = new \backend\modules\postmanager\models\query\NewsQuery(get_called_class());
