<?php
    ...
    class Product extends \soft\db\SActiveRecord
    {
        ...
        {
            return [
                [['manufacturer_id', 'is_name_changed', 'weight_class_id', 'length_class_id', 'sort_order', 'status', 'viewed', 'created_at', 'updated_at', 'action', 'new', 'recommend', 'xit', 'deposit', 'selectedProductId', 'new_time'], 'integer'],
                [['action_beginig_date', 'action_finishing_date'], 'safe'],
                [['price', 'order_count', 'sale_price', 'weight', 'length', 'loan_price'], 'integer'],
                [['slug'], 'string', 'max' => 127],
